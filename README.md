...
```
cd existing_repo
git remote add origin https://git.it.hs-heilbronn.de/cagbo/dockerbookstorejavaspring.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.it.hs-heilbronn.de/cagbo/dockerbookstorejavaspring/-/settings/integrations)
...
>>>>>>> cba55d7aa866576cee7ae64bf88a3141fea26181
=======
# book-store
>>>>>>> 0ced49f8f21c1f8dbe75b20994e5fe44dce41fc3
